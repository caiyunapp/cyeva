...
def test_calc_threshold_hit_ratio(benchmark):
    def inner():
...
def test_calc_threshold_false_alarm_ratio(benchmark):
    def inner():
        THRESHOLD_FAR_CASE = [
            {
                "obs": [1, 2, 2, 2, 2],
...
def test_calc_threshold_ts(benchmark):
    def inner():
        THRESHOLD_TS_CASE = [
            {
                "obs": [1, 2, 2, 2, 2],
...
def calc_correlation_coefficient(benchmark):
    def inner():
        THRESHOLD_TS_CASE = [
            {
                "obs": [1, 2, 3, 4, 5],
